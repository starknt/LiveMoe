...
import { IWallpaperConfigurationFile } from 'common/electron-common/wallpaperPlayer';
...
export namespace WallpaperResource {
  ...
  export function transformUpUpConfiguration(
    ...
    let { name, themeType, preview, description, src } = upupFile;
  ...
  export function transformLivelyInfoConfiguration(
    ...
    let { FileName, Desc, Preview, Title, Author } = livelyInfoFile;
