...
export default class UpdateWindow extends IWindow {
  static readonly id = 'update'
  ...
  static readonly configuration: IWindowOptions = {
    ...
    path: resolveHtmlPath(UpdateWindow.id),
    logic: UpdateWindow.logic,
  }

  static logic(this: UpdateWindow) {
