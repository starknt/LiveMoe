...
import { IEnvironmentConfiguration } from 'common/electron-common/configuration';
import { IWallpaperConfigurationFileSchema } from 'common/electron-common/wallpaperLoader';
